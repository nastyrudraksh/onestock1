...
- OI moved into Market page: compact dark option-chain table (strikes 24350-25000, ATM highlighted, Call OI red bars / Put OI green bars) with CALL OI | PUT OI | TOTAL OI tabs, per-column toggles (Call OI, Put OI, Call/Put OI Chg, Strike, IV), live-ticking values tied to the 4s feed, and clickable strike rows that open a signal note for that strike
