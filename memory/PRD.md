...
- OI moved into Market page: compact dark option-chain table (Strike 24350-25000, IV, Call OI red bars, Put OI green bars, OI-Lakh, OI Chg% per side, ATM strike highlighted); Market page is a 3-column layout per user mockup: Nifty 50 Advance/Decline rail (left) | OI option chain (center) | Instruments card grid (right, incl. FINNIFTY Option/Future, new card style with arrow chip + Signal pill); instruments collapse to one column while the signal note is open
